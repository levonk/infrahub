...
- The client is ~/p/gh/levonk/infrahub/levonk
- has deployed ~/p/gh/levonk/infrahub/shared/active/02-config/ansible/playbooks/ on tailscale
- tailscale is working
- MUST use `cd ~/p/gh/levonk/infrahub && devbox run -- rtk {YOUR COMMAND HERE} ` for shell interaction with all tools like ansible docker etc..
