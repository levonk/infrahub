#  Service Diagram Pack

⭐ **Purpose**

Illustrate the default control flow for the generated Jellyfin stack so the service owner can adapt it once custom dependencies or sidecars are added.
...
sequenceDiagram
    ...
    participant Service as Jellyfin
