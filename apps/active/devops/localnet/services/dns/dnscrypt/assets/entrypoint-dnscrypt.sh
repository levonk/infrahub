...
export PROXY_TOR_SOCKS5_IP="${PROXY_TOR_SOCKS5_IP:-172.20.255.70}"
export PROXY_TOR_SOCKS5_CONTAINER_PORT="${PROXY_TOR_SOCKS5_CONTAINER_PORT:-9050}"
...
echo "[ENTRYPOINT]   PROXY_TOR_SOCKS5_IP=${PROXY_TOR_SOCKS5_IP}" >&2
echo "[ENTRYPOINT]   PROXY_TOR_SOCKS5_CONTAINER_PORT=${PROXY_TOR_SOCKS5_CONTAINER_PORT}" >&2
