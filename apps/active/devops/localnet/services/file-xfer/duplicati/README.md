# Duplicati - Nix-based Docker Service
...
docker run -it --rm duplicati-debug zsh
```
...
|----------|-------------|---------|
| `SERVICE_NAME` | Service identifier | `duplicati` |
| `SERVICE_PORT` | Port the service listens on | `8200` |
