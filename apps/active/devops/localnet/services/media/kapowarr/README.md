...
- **Comics Downloader**: Manage and download comics
...
|----------|-------------|---------|
| `SERVICE_NAME` | Service identifier | `kapowarr` |
| `SERVICE_PORT` | Port the service listens on | `5656` |
| `NODE_ENV` | Environment | `production` |

### Ports

- **5656**: Main service port
