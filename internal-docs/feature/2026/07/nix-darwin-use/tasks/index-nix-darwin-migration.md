...
| 01-002 | Author nix-darwin flake + system modules + per-host configs | [~] In-Progress | `feature/current/nix-darwin-migration/story-01-002-darwin-flake-authoring` | None | true | `infrahub/shared/active/02-config/nix/darwin/` |
| 01-003 | Edit osx-settings.py — add three-layer comment, remove sudo settings | [ ] Todo | `feature/current/nix-darwin-migration/story-01-003-osx-settings-cleanup` | None | true | `dotfiles/home/current/dot_local/bin/` |
