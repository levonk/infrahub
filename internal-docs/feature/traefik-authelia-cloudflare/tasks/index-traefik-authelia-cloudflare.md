...
| 01-002 | Create proxy-authelia Ansible role | feature/current/traefik-authelia-cloudflare/story-01-002-proxy-authelia-role | None | Parallel-safe: true | ansible/roles/proxy-authelia | [~] In-Progress |
