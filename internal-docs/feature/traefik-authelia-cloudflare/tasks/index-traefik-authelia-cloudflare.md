...
| -------- | ----------- | ------ | ------------ | ------------- | ------- | ------ |
| 01-001 | Create proxy-traefik Ansible role | feature/current/traefik-authelia-cloudflare/story-01-001-proxy-traefik-role | None | Parallel-safe: true | ansible/roles/proxy-traefik | [~] In-Progress |
| 01-002 | Create proxy-authelia Ansible role | feature/current/traefik-authelia-cloudflare/story-01-002-proxy-authelia-role | None | Parallel-safe: true | ansible/roles/proxy-authelia | [ ] Todo |
| 01-003 | Create security-crowdsec Ansible role | feature/current/traefik-authelia-cloudflare/story-01-003-security-crowdsec-role | None | Parallel-safe: true | ansible/roles/security-crowdsec | [ ] Todo |
