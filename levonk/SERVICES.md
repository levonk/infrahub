...
> **Auto-generated** from `infrastructure/*.yml` — last updated: 2026-08-09 11:51
> Regenerate with: `just generate-service-catalog`
> Source: `shared/active/02-config/ansible/infrastructure/services.yml`

**63 services** across 6 machines:
  - OCI Cloud Server (cno): 43
  - kckinai (Inference Host): 1
  - dtop202311 (nl — Windows Docker): 16
  - Isolation VM (QEMU on OCI): 1
  - lzkmbp2016 (Laptop — Intel macOS): 1
  - lzkmbp2018 (Laptop — macOS): 1
...
flowchart TD
    ...
    subgraph lzkmbp2016["lzkmbp2016 (Laptop — Intel macOS)"]
        Host_Exit_Node__lzkmbp2016_["🔒 Host Exit Node (lzkmbp2016)"]
    end
    subgraph lzkmbp2018["lzkmbp2018 (Laptop — macOS)"]
        Host_Exit_Node__lzkmbp2018_["🔒 Host Exit Node (lzkmbp2018)"]
    end
    ...
    class NordVPN_Exit_Node__nl_,Tor_Exit_Node__nl_,VPN_Tailscale_Exit__nl_,Tor_Tailscale_Exit__nl_,Host_Exit_Node__nl_,WorldMonitor,WorldMonitor_Redis,JobOps,RustFS,QM_Web_UI,QM_Core,QM_Postgres,Verdaccio_NPM_Registry__nl_,Nix_Harmonia__nl_,Nix_ncps__nl_,Nix_ncro__nl_ machine_dtop
    classDef machine_vm fill:#9B59B6,color:#fff,stroke:#333,stroke-width:1px
    class Isolation_VM machine_vm
    classDef machine_laptop1 fill:#F39C12,color:#fff,stroke:#333,stroke-width:1px
    class Host_Exit_Node__lzkmbp2016_ machine_laptop1
    classDef machine_laptop2 fill:#E67E22,color:#fff,stroke:#333,stroke-width:1px
    class Host_Exit_Node__lzkmbp2018_ machine_laptop2
```
...
| Host Exit Node (lzkmbp2016) | `—` | lzkmbp2016 (Laptop — Intel macOS) | — | — | — | — | VPN / Mesh Networking | [tailscale/tailscale](https://github.com/tailscale/tailscale) |
| Host Exit Node (lzkmbp2018) | `—` | lzkmbp2018 (Laptop — macOS) | — | — | — | — | VPN / Mesh Networking | [tailscale/tailscale](https://github.com/tailscale/tailscale) |
...
| Nix ncps (cno) | `localnet-nix-ncps-cno` | OCI Cloud Server (cno) | [cache.cno.levonk.com](https://cache.cno.levonk.com) | `4524`→`8080` (HTTP (via Traefik)) | traefik-network | — | Infrastructure | [kalbasit/ncps](https://github.com/kalbasit/ncps) |
| Nix ncps (nl) | `localnet-nix-ncps` | dtop202311 (nl — Windows Docker) | [cache.nl.levonk.com](https://cache.nl.levonk.com) | `4524`→`8080` (HTTP (via Traefik)) | traefik-windows-network | — | Infrastructure | [kalbasit/ncps](https://github.com/kalbasit/ncps) |
...
| Host Exit Node (lzkmbp2016) | `—` | lzkmbp2016 (Laptop — Intel macOS) | — | — | — | — | [tailscale/tailscale](https://github.com/tailscale/tailscale) |
| Host Exit Node (lzkmbp2018) | `—` | lzkmbp2018 (Laptop — macOS) | — | — | — | — | [tailscale/tailscale](https://github.com/tailscale/tailscale) |
...
| Nix ncps (cno) | `localnet-nix-ncps-cno` | OCI Cloud Server (cno) | [cache.cno.levonk.com](https://cache.cno.levonk.com) | `4524`→`8080` (HTTP (via Traefik)) | traefik-network | — | [kalbasit/ncps](https://github.com/kalbasit/ncps) |
| Nix ncps (nl) | `localnet-nix-ncps` | dtop202311 (nl — Windows Docker) | [cache.nl.levonk.com](https://cache.nl.levonk.com) | `4524`→`8080` (HTTP (via Traefik)) | traefik-windows-network | — | [kalbasit/ncps](https://github.com/kalbasit/ncps) |
...
| lzkmbp2018 (Laptop — macOS) | `lzkmbp2018.tale-grouper.ts.net` | `arm64` | `~/.ssh/lzkmbp2016-micro-oracle` | `auser` | `lzkmbp2018.mach.levonk.com` | |
