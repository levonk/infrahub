...
### Ansible Variables
- **Inventory**: `~/p/gh/levonk/infrahub/levonk/active/02-config/ansible/inventories/oci.yml`
- **Group Variables**: `~/p/gh/levonk/infrahub/levonk/active/02-config/ansible/inventories/group_vars/cloud_servers.yml`
- **Vault**: `~/p/gh/levonk/infrahub/levonk/active/02-config/ansible/inventories/group_vars/cloud_servers.vault.yml`

### NordVPN Configuration
- **Role**: `~/p/gh/levonk/infrahub/shared/active/02-config/ansible/roles/vpn-nordvpn/`
- **Playbook**: `~/p/gh/levonk/infrahub/shared/active/02-config/ansible/playbooks/cloud-server-nordvpn.yml`

### Tailscale Configuration
- **Role**: `~/p/gh/levonk/infrahub/shared/active/02-config/ansible/roles/vpn-tailscale/`
- **Playbook**: `~/p/gh/levonk/infrahub/shared/active/02-config/ansible/playbooks/cloud-server-vpn.yml`
