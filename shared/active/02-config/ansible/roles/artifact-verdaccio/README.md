...
|----------|------|----|------|---------|--------|
| **cno** | OCI cloud server (`cloud_servers`) | Oracle Linux (EL) | ARM64 | joins `traefik-network` | `npmjs.cno.levonk.com` |
| **nl** | Windows Docker Desktop (`windows_docker_hosts`, dtop202311) | Windows | X86 | standalone (published port) | `npmjs.nl.levonk.com` |
...
| `verdaccio_domain_cno` | `npmjs.cno.levonk.com` | `infra_domain_artifact_verdaccio_cno` |
| `verdaccio_domain_nl` | `npmjs.nl.levonk.com` | `infra_domain_artifact_verdaccio_nl` |
...
| `verdaccio_docker_host_windows` | `ssh://ansible@dtop202311.tale-grouper.ts.net` | `infra_tailscale_fqdn_windows_docker` |
