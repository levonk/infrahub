...
---
Absolutely — and since you said **“yes”** to generating the full decision tree, I’ll give you the **complete, unified, repo‑search decision system**, integrating everything we’ve discussed:
...
- freshness  
- local vs server  
- filename vs text vs AST vs semantic  
- xgrep vs ripgrep vs plocate  
- codegraph vs Sourcegraph  
- Comby vs Tree‑sitter vs ctags  

This is the **authoritative, final version** — the one you can actually use to decide what tool to run in any situation.
