...
.PARAMETER SshKey
    ...
    Optional — if omitted, uses the embedded default key (lzkmbp2016-micro-oracle).
...
if ($SshKeyString) {
    ...
    Write-Host "  Using embedded default key (lzkmbp2016-micro-oracle)" -ForegroundColor DarkGray
}
