...
- [ ] **AI Code Assist (ai-codeassist)**:
  ...
  - [ ] https://github.com/kelviq/tare (where code is spending tokens)
...
- [ ] **Photos**
  ...
  - [ ] Immichframe
  - [ ] https://github.com/HaichaoLihc/create-photo-flipbook-ui (a skill more than service)
...
- [ ] **From OLD Architecture Doc (additional tools & references)**:
  ...
  - [ ] **Automation, Agents & AI Utilities**
    ...
    - [ ] Business monitoring dashboard https://github.com/mreflow/control-center
